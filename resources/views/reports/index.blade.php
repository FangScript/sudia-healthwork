...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Page Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white">{{ __('Reports & Analytics') }}</h1>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Generate and export detailed workforce reports') }}</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700 p-8">
            <div class="text-center">
                ...
                <h3 class="mt-2 text-lg font-medium text-gray-900 dark:text-white">{{ __('Reports Module') }}</h3>
